...
SKILLS = {
    ...
    "plugins/review-panel/skills/ponytail-audit/SKILL.md": (
        "200 files / 30,000 lines",
        "20 files per batch",
        "4 batches concurrently",
        "10\n  batches / 200 file assignments",
        "2 KiB",
        "20 ranked findings / 4 KiB",
    ),
    "plugins/review-panel/skills/improve-codebase-architecture/SKILL.md": (
        "150 files / 25,000 lines",
        "15 files per batch",
        "3 batches concurrently",
        "10 batches / 150 file assignments",
        "30 candidate opportunities",
        "10 ranked candidates / 4",
    ),
    "plugins/triage/skills/detectors/prod-errors/SKILL.md": (
        "50 MiB or 100,000 lines",
        "24 hours",
        "10,000 lines per batch",
        "2 batches concurrently",
        "100 distinct error fingerprints",
        "20 triage-item summaries / 4 KiB",
    ),
    "plugins/review-panel/skills/grill-with-docs/SKILL.md": (
        ...
        "10 decision IDs",
        "2 KiB",
        "grill-with-docs-checkpoint.json",
        "fresh session",
    ),
    "plugins/review-panel/skills/grill-my-taste/SKILL.md": (
        "5–8 forced choices",
        "100 commits / 20 qualifying diffs",
        "8 human questions",
        "8 candidates",
        "2 KiB",
        "grill-my-taste-checkpoint.json",
        "fresh session",
    ),
    "plugins/review-panel/skills/grill-the-schema/SKILL.md": (
        "50\n  schema/source files or 10,000 lines",
        "10 human questions",
        "10 decision IDs",
        "2 KiB",
        "grill-the-schema-checkpoint.json",
        "fresh session",
    ),
}
...
def test_browser_media_and_history_are_artifact_backed() -> None:
    ...
    e2e = (
        ROOT / "plugins/browser-automation/skills/browser-use-e2e/SKILL.md"
