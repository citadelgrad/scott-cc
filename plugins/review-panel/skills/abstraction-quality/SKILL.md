...
description: >-
  Use when adjacent layers feel redundant, when decorator/wrapper patterns add
  boilerplate without depth, or when an abstraction feels leaky. Evaluates
  whether abstractions provide a fundamentally different way of thinking or are
  structurally shallow. Not for module depth (use deep-modules) or information
